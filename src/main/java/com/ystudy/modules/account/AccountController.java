...
import com.ystudy.modules.account.validator.SignUpFormValidator;
...
public class AccountController {
    ...
    // validator를 등록해서 넣어주면 먼저 검증 해준다.
    ...
    public String resendConfirmEmail(Account account, Model model) {
