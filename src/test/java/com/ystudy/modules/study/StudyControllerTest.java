...
public class StudyControllerTest extends AbstractContainerBaseTest {
    ...
    void createStudy_success() throws Exception {
        ...
        assertNotNull(study);
        Account account = accountRepository.findByNickname("youngsoo");
    ...
    void viewStudy() throws Exception {
        ...
        Account keesun = accountRepository.findByNickname("youngsoo");
    ...
    void joinStudy() throws Exception {
        ...
        assertTrue(study.getMembers().contains(youngsoo));
    }
    ...
    void leaveStudy() throws Exception {
        ...
        Study study = studyFactory.createStudy("test-study", whiteship);
        Account youngsoo = accountRepository.findByNickname("youngsoo");
        studyService.addMember(study, youngsoo);

        mockMvc.perform(get("/study/" + study.getPath() + "/leave"))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/study/" + study.getPath() + "/members"));

        assertFalse(study.getMembers().contains(youngsoo));
    }
